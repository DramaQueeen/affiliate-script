    <table class="ui blue celled table" id="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="<?php echo URL;?>updateTop/<?php echo $r['id'];?>" class="ui orange button"><i class="pencil alternate icon"></i></a></td>
                <td><a href="<?php echo URL;?>deleteTop/<?php echo $r['id'];?>" class="delete ui red button"><i class="close icon"></i></a></td>
            </tr>
            <?php endforeach;?>
        </tbody>
    </table>