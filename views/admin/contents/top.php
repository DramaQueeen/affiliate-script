...
<head>
    ...
    <title><?php echo NAME; ?> | Top List</title>
...
<body>
    ...
    <div class="ui center aligned container">
        <div class="s-st">
            ...
            <button class="ui primary button" id="add">ADD TOP LIST</button>
        </div>
        <div class="ui small modal">
            <i class="close icon"></i>
            <div class="header center aligned">ADD TOP LIST</div>
            <div class="content">
                <form class="ui form" id="form" name="form" method="post" action="<?php echo URL; ?>ajax/addTop.php">
                    <div class="field">
    ...
    <?php  
       $getList = $get->admin_top_list_controller();
    ?>
    </div>
