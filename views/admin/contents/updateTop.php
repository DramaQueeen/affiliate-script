...
<head>
    ...
    <link rel="stylesheet" href="<?php echo URL;?>views/assets/css/semantic.min.css">
    <link rel="stylesheet" href="<?php echo URL;?>views/assets/css/sweetalert2.min.css">
    <link rel="stylesheet" href="<?php echo URL;?>views/assets/css/datatables.min.css">
    <link rel="stylesheet" href="<?php echo URL;?>views/assets/css/main.css">
    <script src="<?php echo URL;?>views/assets/js/jquery.min.js"></script>
    <script src="https://kit.fontawesome.com/7703888b0f.js"></script>
</head>
...
<body>
    ...
    <div class="ui center aligned container">
        <div class="form-wrap">
            <form class="ui form" id="form" name="form" method="post" action="<?php echo URL; ?>ajax/updateTop.php">
            <div class="field">
                <label>ID</label>
